...
Question(question: "Quelle est la principale raison pour laquelle on voit toujours la même face de la Lune depuis la Terre ?",
        answers: ["Parce que la Lune ne tourne pas sur elle-meme", "Parce que la Lune tourne sur elle-même à la même vitesse qu’elle tourne autour de la Terre","Parce que la Terre bloque la lumière sur l’autre face"],
         correctAnswer: 1  )
